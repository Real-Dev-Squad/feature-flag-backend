...
- You can check for any **unassigned** [issues](https://github.com/Real-Dev-Squad/feature-flag-backend/issues) and **comment** on that issue that you'd like to get that issue assigned to you. (Remember: Do not work on issues assigned to someone else and do not work on any issue without having it assigned to you.)
...
Now go to your forked repository and you'll see that **This branch is xx commits ahead of Real-Dev-Squad:develop.** Right next to it will be an option to **Pull Request**. Click on it, and submit your pull request (also known as _PR_) explaining what you've done.
